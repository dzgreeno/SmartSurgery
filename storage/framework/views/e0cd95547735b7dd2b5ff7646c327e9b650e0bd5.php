...
<div class="topbar">
  ...
  {
<?php if(in_array(session('firebase_role', 'guest'), ['admin','head_men'])): ?>
    <a href="<?php echo e(route('surgery.head_men')); ?>" class="head-btn">
...
<div class="modal-overlay" id="headModal">
  ...
  <div class="modal-box">
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" id="headForm" novalidate>
      ...
      <input type="hidden" name="redirect_to" value="<?php echo e(route('surgery.men')); ?>">
...
</html><?php /**PATH D:\web apps\Github-Project\SmartSurgery\resources\views/surgery_men.blade.php ENDPATH**/ ?>