...
<title>سجل الأدوية — مستشفى عاشور زيان</title>
...
<div class="topbar">
  ...
  {
<?php if(in_array(session('firebase_role', 'guest'), ['admin','head_women'])): ?>
    <a href="<?php echo e(route('surgery.head_women')); ?>" class="head-btn">
...
<div class="topbar-user">
    <div class="user-av"><?php echo e(mb_substr(trim(session('firebase_user.fname', 'زائر') . ' ' . session('firebase_user.lname', '')), 0, 1)); ?></div>
    <span class="user-name"><?php echo e(trim(session('firebase_user.fname', 'زائر') . ' ' . session('firebase_user.lname', ''))); ?></span>
...
<div class="body-wrap">
  ...
  <aside class="sidebar">
    ...
    <div class="sidebar-section">
      ...
      <button class="nav-btn" onclick="location.href='/surgery/women'">
    ...
    <div class="sidebar-section">
      ...
      <a href="<?php echo e(route('daily-meds')); ?>" class="nav-btn active">
      ...
      <a href="<?php echo e(route('fiche-navette')); ?>" class="nav-btn">
      ...
      <a href="<?php echo e(route('patient-movements')); ?>" class="nav-btn">
      ...
      <div class="chat-header">
        ...
        <div class="chat-members" id="chatMembers">
          ...
          <div class="member-tag">
            ...
            <?php echo e(trim(session('firebase_user.fname', 'زائر') . ' ' . session('firebase_user.lname', ''))); ?>
...
<div class="modal-overlay" id="headModal">
  ...
  <div class="modal-box">
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" id="headForm" novalidate>

      <?php echo csrf_field(); ?>

      <input type="hidden" name="redirect_to" value="<?php echo e(route('surgery.women')); ?>">
...
const ME = {
  ...
  name: "<?php echo e(trim(session('firebase_user.fname', 'زائر') . ' ' . session('firebase_user.lname', ''))); ?>",

  init: "<?php echo e(mb_substr(trim(session('firebase_user.fname', 'زائر') . ' ' . session('firebase_user.lname', '')), 0, 1)); ?>",

  id:   <?php echo e(session('firebase_uid', 'null')); ?>,
...
</html><?php /**PATH D:\web apps\Github-Project\SmartSurgery\resources\views/daily-meds.blade.php ENDPATH**/ ?>