...
<nav class="navbar" id="navbar">
  ...
  <div class="nav-actions">
    ...
    <a href="<?php echo e(route('login')); ?>" class="nav-login">تسجيل الدخول</a>
  </div>
</nav>
...
<header class="hero" id="hero">
  <div class="hero-slider">
    <div class="hero-slide active" style="background-image:url('<?php echo e(asset('images/hospital.jpg')); ?>')"></div>
    <div class="hero-slide" style="background-image:url('<?php echo e(asset('images/Captur.jpg')); ?>')"></div>
    <div class="hero-slide" style="background-image:url('<?php echo e(asset('images/Capt9.jpg')); ?>')"></div>
    <div class="hero-slide" style="background-image:url('<?php echo e(asset('images/mm.jpg')); ?>')"></div>
  </div>
  <div class="hero-overlay"></div>
  <div class="hero-content">
    <div class="hero-badge">🏅 أولاد جلال — بسكرة</div>
    <h1 class="hero-title">
    ...
    <div class="dept-grid">
      <div class="dept-card reveal">
        <div class="dept-img-wrap">
          <img src="https://images.unsplash.com/photo-1584820927498-cfe5211fd8bf?w=600&h=300&fit=crop&auto=format" alt="جراحة النساء والتوليد" onerror="this.style.background='#0f4c5c';this.style.minHeight='190px'">
        ...
        <div class="dept-body">
          ...
          <a href="<?php echo e(route('surgery.women')); ?>" class="dept-link">اكتشف القسم ◄</a>
        </div>
      </div>
      <div class="dept-card reveal">
        <div class="dept-img-wrap">
          <img src="https://images.unsplash.com/photo-1555252333-9f8e92e65df9?w=600&h=300&fit=crop&auto=format" alt="الأمومة والطفولة" onerror="this.style.background='#0f4c5c';this.style.minHeight='190px'">
          <div class="dept-overlay"></div>
        </div>
        <div class="dept-body">
          <div class="dept-icon">👶</div>
          ...
          <a href="<?php echo e(route('maternite')); ?>" class="dept-link">اكتشف القسم ◄</a>
        </div>
      </div>
      <div class="dept-card reveal">
        <div class="dept-img-wrap">
          <img src="https://images.unsplash.com/photo-1551190822-a9333d879b1f?w=600&h=300&fit=crop&auto=format" alt="قسم الطوارئ" onerror="this.style.background='#0f4c5c';this.style.minHeight='190px'">
          <div class="dept-overlay"></div>
        </div>
        <div class="dept-body">
          <div class="dept-icon">🚨</div>
          ...
          <a href="<?php echo e(route('services')); ?>" class="dept-link">اكتشف القسم ◄</a>
        </div>
      </div>
      <div class="dept-card reveal">
        <div class="dept-img-wrap">
          <img src="https://images.unsplash.com/photo-1579165466741-7f35e4755660?w=600&h=300&fit=crop&auto=format" alt="التشخيص والمخبر" onerror="this.style.background='#0f4c5c';this.style.minHeight='190px'">
          <div class="dept-overlay"></div>
        </div>
        <div class="dept-body">
          <div class="dept-icon">🔬</div>
  ...
  <div style="max-width:1200px;margin:auto">
    ...
    <div class="info-grid">
      <div class="info-card reveal">
        <img src="https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=600&h=280&fit=crop&auto=format" alt="حقوق المريض" class="info-card-img" onerror="this.style.display='none'">
        ...
        <div class="info-card-footer"><a href="<?php echo e(route('about')); ?>" class="read-more">اقرأ المزيد ◄</a></div>
      </div>
      <div class="info-card reveal">
        <img src="https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&h=280&fit=crop&auto=format" alt="شركاء الصحة" class="info-card-img" onerror="this.style.display='none'">
        <div class="info-card-body">
      ...
      <div class="info-card reveal">
        <img src="https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=600&h=280&fit=crop&auto=format" alt="رعاية المرضى" class="info-card-img" onerror="this.style.display='none'">
        <div class="info-card-body">
        ...
        <div class="info-card-footer"><a href="<?php echo e(route('services')); ?>" class="read-more">اقرأ المزيد ◄</a></div>
      </div>
    </div>
  </div>
</section>
...
<div class="contact-strip">
  <div class="contact-inner">
    <div class="contact-card reveal">
      ...
      <div class="contact-info"><h4>موقعنا</h4><p>أولاد جلال — ولاية بسكرة<br>الجزائر</p></div>
    </div>
    <div class="contact-card reveal">
      <div class="contact-icon">📞</div>
...
<footer>
  ...
  <div class="footer-bottom">
    © <?php echo e(date('Y')); ?> — <span>المؤسسة العمومية الاستشفائية عاشور زيان</span> — جميع الحقوق محفوظة 🇩🇿
  </div>
</footer>
...
</html><?php /**PATH D:\web apps\Github-Project\SmartSurgery\resources\views/home.blade.php ENDPATH**/ ?>