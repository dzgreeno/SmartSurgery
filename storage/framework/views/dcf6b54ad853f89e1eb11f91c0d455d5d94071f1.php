...
<div class="login-container">
  ...
  <div class="login-card">
    ...
    <form method="POST" action="/login">
      ...
      <div class="form-group">
        ...
        <input type="email" name="email" placeholder="example@hospital.com" required value="<?php echo e(old('email')); ?>">
      </div>
  ...
  <a href="<?php echo e(route('home')); ?>" class="back-home">→ العودة إلى الصفحة الرئيسية</a>
</div>

</body>
</html><?php /**PATH D:\web apps\Github-Project\SmartSurgery\resources\views/auth/login.blade.php ENDPATH**/ ?>