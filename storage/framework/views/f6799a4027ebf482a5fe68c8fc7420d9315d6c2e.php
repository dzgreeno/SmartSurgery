...
.top-strip { background: var(--deep); padding: 9px 50px; display: flex; justify-content: space-between; align-items: center; font-size: 12px; color: rgba(255,255,255,0.7); }
.top-strip .emergency { display: flex; align-items: center; gap: 8px; color: var(--gold-light); font-weight: 600; font-size: 13px; }
.top-strip .emergency::before { content: "✚"; display: inline-flex; width: 20px; height: 20px; background: var(--gold); color: var(--deep); border-radius: 50%; align-items: center; justify-content: center; font-size: 11px; font-weight: 700; }
.top-strip .info { display: flex; gap: 24px; }

.navbar { background: var(--white); padding: 0 50px; display: flex; justify-content: space-between; align-items: center; height: 70px; position: sticky; top: 0; z-index: 100; box-shadow: 0 1px 0 rgba(0,0,0,0.08), 0 4px 24px rgba(0,0,0,0.06); }
.logo-wrap { display: flex; align-items: center; gap: 12px; }
.logo-icon { width: 42px; height: 42px; background: linear-gradient(135deg, var(--teal), var(--navy)); border-radius: 10px; display: flex; align-items: center; justify-content: center; color: var(--gold); font-size: 20px; font-weight: 700; font-family: "Amiri", serif; flex-shrink: 0; }
.logo-text .name { font-size: 13.5px; font-weight: 700; color: var(--navy); }
.logo-text .sub { font-size: 10.5px; color: var(--muted); }
.nav-links { display: flex; list-style: none; gap: 4px; }
.nav-links a { text-decoration: none; font-size: 13px; color: var(--text); padding: 7px 14px; border-radius: 8px; transition: all 0.2s; font-weight: 500; }
.nav-links a:hover { background: var(--cream); color: var(--teal); }
.nav-links a.active { background: var(--teal); color: white; }
.nav-cta { background: linear-gradient(135deg, var(--gold), #b8922f); color: var(--deep) !important; padding: 9px 20px !important; border-radius: 8px !important; font-weight: 700 !important; font-size: 12.5px !important; }
...
<div class="top-strip">
  <div class="emergency">طوارئ 24/24 — 014 25 36 78</div>
  <div class="info">
    <span>⏰ 08:00 – 20:00</span>
    <span>📍 أولاد جلال، ولاية بسكرة</span>
  </div>
</div>
...
<nav class="navbar">
  <div class="logo-wrap">
    ...
    <div class="logo-text">
      <div class="name">مستشفى عاشور زيان</div>
...
<div class="section reveal">
  ...
  <div class="about-grid">
    <div class="about-image-wrap">
      <img src="images/hospital.jpg" alt="مستشفى عاشور زيان">
...
<div class="services-bg">
  <div class="section" style="padding-top:0;padding-bottom:0">
    ...
    <div class="services-grid reveal">
      ...
      <div class="service-card">
        <div class="sc-img"><img src="images/Capture 9.jpg" alt="الطاقم الطبي"></div>
        <div class="sc-body">
...
</html><?php /**PATH D:\web apps\Github-Project\SmartSurgery\resources\views/about.blade.php ENDPATH**/ ?>