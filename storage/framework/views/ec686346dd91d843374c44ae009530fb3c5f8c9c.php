...
nav{
  ...
  box-shadow:0 2px 16px rgba(219,39,119,.06);
}
...
.nav-mark{
  ...
  box-shadow:0 4px 14px rgba(219,39,119,.3);font-size:18px;
}
.nav-txt strong{display:block;font-size:13.5px;font-weight:800;color:var(--text)}
.nav-txt span{font-size:10.5px;color:var(--muted)}
...
.nav-links a:hover{background:var(--bg2);color:var(--pink)}
.nav-cta{
...
.nav-cta:hover{transform:translateY(-1px);box-shadow:0 8px 22px rgba(219,39,119,.38)}
.nav-back{
  display:flex;align-items:center;gap:6px;
...
.nav-back:hover{background:var(--bg2);color:var(--pink);border-color:var(--pinkbd)}
...
<nav>
  <a href="<?php echo e(route('home')); ?>" class="nav-brand">
    ...
    <div class="nav-txt">
      <strong>مستشفى عاشور زيان</strong>
      <span>قسم الأمومة والطفولة — أولاد جلال</span>
    </div>
  </a>
  <div class="nav-links">
    <a href="#leave">عطلة الأمومة</a>
    <a href="#cnas">CNAS</a>
    <a href="#tips">نصائح صحية</a>
    <a href="#articles">مقالات</a>
    <a href="#checklist">قائمة التحضير</a>
    <a href="#gallery">معرض الصور</a>
    <a href="#contact">اتصل بنا</a>
  </div>
  <a href="<?php echo e(route('home')); ?>" class="nav-back">
    <svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.3" viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
    الرئيسية
  </a>
</nav>
  ...
  <div class="sec-in">
    ...
    <div class="gal-grid">
      <div class="gal-item gal-big">
        <img src="<?php echo e(asset('images/maternite-1.jpg')); ?>" alt="رعاية الأم والمولود" loading="lazy"
      ...
      <div class="gal-item gal-big">
        <img src="<?php echo e(asset('images/maternite-6.jpg')); ?>" alt="لحظات لا تُنسى" loading="lazy"
...
<footer>
  <span>© <?php echo e(date('Y')); ?> <strong>مستشفى عاشور زيان</strong> — قسم الأمومة والطفولة — أولاد جلال، ب<?php /**PATH D:\web apps\Github-Project\SmartSurgery\resources\views/maternite.blade.php ENDPATH**/ ?>