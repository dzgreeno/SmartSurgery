...
<title>جراحة العظام والمفاصل | مستشفى عاشور زيان</title>
...
<div class="top-bar">
  ...
  <span>⏰ ساعات الاستقبال: 08:00 — 20:00 &nbsp;|&nbsp; 📍 أولاد جلال، ولاية أولاد جلال</span>
</div>
...
<div class="back-bar">
  ...
  <div class="breadcrumb">
    ...
    <span>›</span>
    <span class="breadcrumb-cur">🦴 جراحة العظام والمفاصل</span>
  </div>
</div>
...
<section class="page-hero">
  ...
  <div class="page-hero-inner">
    <div>
      ...
      <h1 class="hero-title">جراحة <span>العظام والمفاصل</span></h1>
      <p class="hero-subtitle">خدمات طبية متخصصة في تشخيص وعلاج أمراض وإصابات الجهاز العضلي الهيكلي بأحدث التقنيات الجراحية وبأيدٍ طبية خبيرة.</p>
      <div class="hero-stats">
        <div class="hstat"><div class="hstat-num">+500</div><div class="hstat-lbl">عملية سنوياً</div></div>
        <div class="hstat"><div class="hstat-num">8</div><div class="hstat-lbl">جراحون متخصصون</div></div>
        <div class="hstat"><div class="hstat-num">24/7</div><div class="hstat-lbl">متابعة مستمرة</div></div>
      </div>
    </div>
    <div class="hero-float-card">
      <span class="big-em">🦴</span>
      <h4>قسم جراحة العظام</h4>
      <p>رعاية متكاملة بأعلى معايير الجودة الطبية</p>
    </div>
  </div>
</section>
...
<section class="about-sec">
  <div class="about-grid">
    <div class="about-text reveal">
      <h3>ما هي جراحة العظام والمفاصل؟</h3>
      <p>جراحة العظام والمفاصل تخصص طبي متقدم يهتم بتشخيص وعلاج أمراض وإصابات الجهاز العضلي الهيكلي، بما فيها العظام والمفاصل والأربطة والأوتار.</p>
      <p>يضم قسمنا كادراً طبياً خبيراً يمتلك تجربة واسعة في جميع أنواع الجراحات العظمية، من الكسور البسيطة إلى عمليات استبدال المفاصل الكاملة.</p>
      <div class="feat-list">
        <div class="feat-item"><span class="feat-icon">🏆</span><div class="feat-text"><strong>تقنيات جراحية متطورة</strong><span>أحدث الأجهزة لضمان أفضل النتائج الجراحية</span></div></div>
        <div class="feat-item"><span class="feat-icon">❤️‍🩹</span><div class="feat-text"><strong>رعاية ما بعد العملية</strong><span>متابعة دقيقة وبرامج تأهيل فيزيائي متخصصة</span></div></div>
        <div class="feat-item"><span class="feat-icon">🔬</span><div class="feat-text"><strong>تشخيص دقيق وسريع</strong><span>أجهزة تصوير متطورة للتشخيص بدقة عالية</span></div></div>
      </div>
    </div>
    <div class="reveal-l">
      <div class="about-visual">
        ...
        <h4>قسم جراحة العظام</h4>
        <p>نهتم بسلامة هيكلك العظمي بأعلى معايير الجودة وأحدث التقنيات الجراحية المعتمدة.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="ops-sec">
  <div style="max-width:1200px;margin:auto">
    <div class="sec-header reveal">
      ...
      <h2 class="sec-title">أهم العمليات الجراحية</h2>
      <div class="sec-line"></div>
    </div>
    <div class="ops-grid">
      <div class="op-card reveal"><div class="op-icon">🦵</div><div class="op-title">استبدال مفصل الركبة</div><p class="op-desc">استبدال المفصل التالف بطرف اصطناعي لاستعادة الحركة الطبيعية والتخلص من الألم المزمن.</p><span class="op-tag">🔹 جراحة كبرى</span></div>
      <div class="op-card reveal"><div class="op-icon">🦴</div><div class="op-title">علاج الكسور المعقدة</div><p class="op-desc">إعادة تثبيت الكسور المعقدة باستخدام الصفائح المعدنية والمسامير الجراحية المتخصصة.</p><span class="op-tag">🔹 جراحة تثبيت</span></div>
      <div class="op-card reveal"><div class="op-icon">⚡</div><div class="op-title">جراحة الرباط الصليبي</div><p class="op-desc">إصلاح وإعادة بناء الرباط الصليبي بتقنيات تنظير المفصل الحديثة لعودة سريعة للنشاط.</p><span class="op-tag">🔹 تنظير مفصل</span></div>
      <div class="op-card reveal"><div class="op-icon">🫀</div><div class="op-title">جراحة العمود الفقري</div><p class="op-desc">علاج الانزلاق الغضروفي وتضيق القناة الشوكية بأحدث التقنيات الجراحية الدقيقة.</p><span class="op-tag">🔹 دقة عالية</span></div>
      <div class="op-card reveal"><div class="op-icon">🦾</div><div class="op-title">استبدال مفصل الورك</div><p class="op-desc">استبدال المفصل المتآكل بطرف اصطناعي متطور لاستعادة الحركة وتحسين جودة الحياة.</p><span class="op-tag">🔹 جراحة كبرى</span></div>
      <div class="op-card reveal"><div class="op-icon">🤲</div><div class="op-title">جراحة اليد والمعصم</div><p class="op-desc">علاج متلازمة النفق الرسغي وإصلاح أوتار اليد بتقنيات جراحية دقيقة ومتخصصة.</p><span class="op-tag">🔹 جراحة دقيقة</span></div>
    </div>
  </div>
</section>
...
<section class="visit-sec">
  <div style="max-width:1200px;margin:auto">
    <div class="sec-header reveal">
      ...
      <h2 class="sec-title">متى يجب زيارة الطبيب؟</h2>
      <div class="sec-line"></div>
    </div>
    <div class="visit-grid">
      <div class="visit-card reveal"><div class="visit-icon">😣</div><h4>ألم مستمر في المفاصل</h4><p>إذا استمر الألم لأكثر من أسبوع ولم يتحسن بالراحة، يجب استشارة الطبيب فوراً.</p></div>
      <div class="visit-card reveal"><div class="visit-icon">🦵</div><h4>تورم أو احمرار</h4><p>التورم المفاجئ أو الاحمرار حول المفاصل قد يدل على التهاب يستوجب الفحص الطبي.</p></div>
      <div class="visit-card reveal"><div class="visit-icon">🚶</div><h4>صعوبة في الحركة</h4><p>عدم القدرة على تحريك المفصل بشكل طبيعي أو الشعور بتصلب صباحي يستدعي الفحص.</p></div>
      <div class="visit-card reveal"><div class="visit-icon">⚠️</div><h4>إصابات رياضية</h4><p>أي إصابة خلال ممارسة الرياضة خاصة في الركبة تحتاج تقييماً طبياً دقيقاً وسريعاً.</p></div>
    </div>
  </div>
</section>

<!-- ADVICE -->
<section class="advice-sec">
  <div style="max-width:1200px;margin:auto">
    <div class="sec-header reveal">
      <span class="eyebrow" style="background:rgba(255,255,255,.1);color:var(--gold)">نصائح طبية</span>
      <h2 class="sec-title" style="color:#fff">نصائح ما بعد العملية</h2>
      <div class="sec-line"></div>
    </div>
    <div class="advice-grid">
      <div class="adv-card reveal"><span class="adv-icon">🏃</span><div class="adv-title">العلاج الفيزيائي</div><p class="adv-text">الالتزام ببرنامج التأهيل الفيزيائي المحدد من الطبيب ضروري لاستعادة الحركة والقوة العضلية.</p></div>
      <div class="adv-card reveal"><span class="adv-icon">💊</span><div class="adv-title">الدواء والمتابعة</div><p class="adv-text">تناول الأدوية الموصوفة بانتظام والحضور لجميع مواعيد المتابعة الدورية مع الطبيب المعالج.</p></div>
      <div class="adv-card reveal"><span class="adv-icon">🚫</span><div class="adv-title">تجنب الإجهاد</div><p class="adv-text">تجنب الحركات العنيفة والأحمال الثقيلة في المرحلة الأولى من الشفاء لضمان التعافي الكامل.</p></div>
      <div class="adv-card reveal"><span class="adv-icon">🥗</span><div class="adv-title">التغذية السليمة</div><p class="adv-text">نظام غذائي غني بالكالسيوم وفيتامين D لدعم التئام الكسور وتقوية العظام بشكل فعّال.</p></div>
    </div>
  </div>
</section>
...
<section class="appt-sec" id="appointment">
  <div style="max-width:1200px;margin:auto">
    <div class="sec-header reveal">
      ...
      <h2 class="sec-title">احجز موعدك في قسم العظام</h2>
      <div class="sec-line"></div>
    </div>
    <div class="appt-wrap reveal">
      ...
      <div class="appt-body">
        ...
        <div class="form-row">
          ...
          <div class="fg"><label>العمر</label><input type="number" id="fage" placeholder="35"></div>
        </div>
        <div class="fg">
          ...
          <select id="ftype">
            ...
            <option>علاج كسور وإصابات</option>
            <option>استبدال مفصل الركبة</option>
            <option>استبدال مفصل الورك</option>
            <option>جراحة العمود الفقري</option>
            <option>رباط صليبي وإصابات رياضية</option>
...
<div class="contact-strip">
  <div class="contact-inner">
    <div class="contact-card reveal"><div class="cicon">📍</div><div class="cinfo"><h4>موقعنا</h4><p>أولاد جلال — ولاية أولاد جلال<br>الجزائر</p></div></div>
  ...
  <div class="footer-inner">
    ...
    <div class="footer-col">
      ...
      <ul class="footer-links">
        ...
        <li><a href="{{ route('orthopedics') }}">جراحة العظام</a></li>
        <li><a href="#">الطوارئ</a></li>
      </ul>
    </div>
    <div class="footer-col">
      <h4>معلومات الاتصال</h4>
      <div class="fci"><span class="icon">📍</span><p>أولاد جلال — ولاية أولاد جلال، الجزائر</p></div>
      <div class="fci"><span class="icon">📞</span><p>014253678</p></div>
      <div class="fci"><span class="icon">🚑</span><p>الطوارئ: متاح 24/24</p></div>
      <div class="fci"><span class="icon">📧</span><p>contact@hopital-achour-ziane.dz</p></div>
    </div>
  </div>
  <div class="footer-bottom">© {{ date('Y') }} — <span>المؤسسة العمومية الاستشفائية عاشور زيان</span> — جميع الحقوق محفوظة 🇩🇿</div>
</footer>
...
function handleBooking() {
  ...
  if (valid) {
    alert('✅ تم استلام طلب الحجز بنجاح!\nسيتصل بك فريق قسم جراحة العظام قريباً لتأكيد الموعد.');
