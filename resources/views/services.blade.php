...
.hero-bg {
  ...
  background-image: url("https://i.ibb.co/zhwRS7mT/project-image-10.jpg");
...
<nav class="navbar" id="navbar">
  <a href="{{ route('home') }}" class="nav-logo" style="text-decoration:none">
    ...
    <div>
      ...
      <span class="nav-logo-sub">المؤسسة الاستشفائية</span>
    </div>
  </a>
  <ul class="nav-links">
    ...
    <li><a href="{{ route('services') }}" class="active">خدماتنا</a></li>
    ...
    <div class="services-grid">
      ...
      <div class="service-card reveal">
        <div class="card-img-wrap">
          <img src="https://i.ibb.co/CK2J1924/project-image-13.jpg" alt="الأمومة">
        ...
        <div class="card-footer">
          <a href="{{ route('maternite') }}" class="card-link">اكتشف القسم ◄</a>
      ...
      <div class="service-card reveal">
        <div class="card-img-wrap">
          <img src="https://i.ibb.co/6Rdy8hdN/project-image-11.jpg" alt="الأطفال">
          <div class="card-img-overlay"></div>
      ...
      <div class="service-card reveal">
        <div class="card-img-wrap">
          <img src="{{ asset('images/482027355_9703889418.jpg') }}" alt="الطوارئ">
          <div class="card-img-overlay"></div>
      ...
      <div class="service-card reveal">
        <div class="card-img-wrap">
          <img src="https://i.ibb.co/tTpZ8qLF/project-image-12.jpg" alt="التحاليل">
          <div class="card-img-overlay"></div>
      ...
      <div class="service-card reveal">
        <div class="card-img-wrap">
          <img src="https://i.ibb.co/fd0J5FC3/project-image-6.jpg" alt="جراحة">
          <div class="card-img-overlay"></div>
        ...
        <div class="card-footer">
          <a href="{{ route('surgery.women') }}" class="card-link">اكتشف القسم ◄</a>
          <span class="card-avail">متاح الآن</span>
        </div>
      </div>
      ...
      <div class="service-card reveal">
        <div class="card-img-wrap">
          <img src="https://i.ibb.co/XZ7BmHDf/project-image-2.jpg" alt="أشعة">
          <div class="card-img-overlay"></div>
...
<section class="cta-section">
  <div class="cta-inner reveal">
    ...
    <div class="cta-btns">
      <a href="{{ route('contact') }}" class="btn-teal">📅 احجز موعدك الآن</a>
  ...
  <div class="footer-inner">
    ...
    <div class="footer-col">
      ...
      <ul class="footer-links">
        ...
        <li><a href="{{ route('maternite') }}">الأمومة</a></li>
        <li><a href="{{ route('about') }}">نبذة عنا</a></li>
        <li><a href="{{ route('contact') }}">اتصل بنا</a></li>
      </ul>
    </div>
    <div class="footer-col">
      ...
      <div class="footer-contact">
        <p>📍 أولاد جلال، ولاية أولاد جلال</p>
        <p>📞 014253678</p>
        <p>🚑 طوارئ: 24/24</p>
        <p>⏰ 08:00 – 20:00</p>
      </div>
