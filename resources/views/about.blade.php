...
<div class="top-bar">
  ...
  <span>⏰ ساعات الاستقبال: 08:00 — 20:00 &nbsp;|&nbsp; 📍 ولاية أولاد جلال</span>
</div>
...
<div id="cityModal" class="modal-overlay" onclick="closeModal(event)">
  <div class="modal-box">
    ...
    <div class="modal-header">
      ...
      <div>
        <div class="modal-tag">بلدية — ولاية أولاد جلال</div>
...
<footer>
  ...
  <div class="footer-bottom">
    ...
    <span>أولاد جلال، ولاية أولاد جلال، الجزائر</span>
  </div>
</footer>
...
const cities = {
  'ouled-jalal': {
    ...
    desc: 'أولاد جلال مدينة جزائرية تقع في الجهة الشمالية الغربية من ولاية أولاد جلال، وتُعدّ مركزاً حضرياً وتجارياً مهماً في منطقة الزيبان. تشتهر بإنتاج التمور عالية الجودة، ولا سيما تمر دقلة نور، وتستضيف مستشفى عاشور زيان الذي يُعدّ المرفق الصحي الرئيسي للمنطقة.',
  ...
  'sidi-khaled': {
    ...
    desc: 'سيدي خالد بلدية أثرية تقع في ولاية أولاد جلال، تشتهر بموقعها الاستراتيجي على الطريق الرابط بين الشمال والجنوب. تتميز بطابعها الديني والتراثي، حيث تضم ضريح الولي سيدي خالد، ويعتمد سكانها اعتماداً كبيراً على الخدمات الصحية المقدمة في مستشفى عاشور زيان.',
  ...
  'doucen': {
    ...
    desc: 'الدوسن بلدية هادئة تقع في ولاية أولاد جلال، تتميز بطابعها الريفي وبساتين النخيل الممتدة. يعتمد سكانها في الغالب على الزراعة ورعي الأغنام، ويتلقون خدماتهم الصحية المتخصصة في مستشفى عاشور زيان بأولاد جلال.',
  ...
  'chaiba': {
    ...
    desc: 'الشعيبة بلدية صغيرة تقع في الجنوب الغربي من ولاية أولاد جلال، تتميز بمناخها الجاف وطبيعتها الصحراوية الرائعة. يرتكز اقتصاد سكانها على تربية الإبل والأغنام وزراعة النخيل، ويعتمدون على مستشفى عاشور زيان كمرفق صحي رئيسي.',
  ...
  'ras-miaad': {
    ...
    desc: 'رأس الميعاد بلدية تقع في أقاصي الجنوب الشرقي من ولاية أولاد جلال، تتميز بمشاهد صحراوية خلابة وتضاريس متنوعة. تعتمد على الرعي والزراعة التقليدية، ويُمثّل مستشفى عاشور زيان الملجأ الصحي الأساسي لسكانها في الحالات المستعصية.',
