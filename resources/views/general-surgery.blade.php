...
<title>الجراحة العامة | مستشفى عاشور زيان</title>
...
<nav class="navbar" id="navbar">
  ...
  <ul class="nav-links">
    ...
    <li class="dropdown">
      <span class="dropdown-toggle" style="cursor:pointer; color:var(--teal-mid); font-weight:700;">انواع الجراحة▾</span>
...
<div class="back-bar">
  ...
  <div class="breadcrumb">
    ...
    <span>›</span>
    <span class="breadcrumb-cur">🩺 الجراحة العامة</span>
  </div>
</div>
...
<section class="page-hero">
  ...
  <div class="page-hero-inner">
    <div>
      ...
      <h1 class="hero-title">قسم <span>الجراحة العامة</span></h1>
      <p class="hero-subtitle">يضم القسم أمهر الجراحين للتعامل مع مختلف العمليات الجراحية الدقيقة والكبرى باستخدام أحدث المعدات الطبية والمناظير وغرف عمليات معقمة باعلى التجهيزات.</p>
      <div class="hero-stats">
        <div class="hstat"><div class="hstat-num">+800</div><div class="hstat-lbl">عملية سنوياً</div></div>
        <div class="hstat"><div class="hstat-num">12</div><div class="hstat-lbl">جراحين وأطباء تخدير</div></div>
        <div class="hstat"><div class="hstat-num">24/7</div><div class="hstat-lbl">طوارئ جراحية</div></div>
      </div>
    </div>
    <div class="hero-float-card">
      <span class="big-em">🩺</span>
      <h4>الجراحة العامة</h4>
      <p>عناية جراحية شاملة مع ضمان أعلى مستويات التعقيم والأمان</p>
    </div>
  </div>
</section>
...
<section class="about-sec">
  <div class="about-grid">
    <div class="about-text reveal">
      <h3>ما هي الجراحة العامة؟</h3>
      <p>الجراحة العامة تخصص طبي واسع يشمل إجراء عمليات في مختلف أجزاء الجسم، ويمتد ليعالج مشاكل الجهاز الهضمي، الكبد، القنوات الصفراوية، البنكرياس، بالإضافة للغدد وجراحة الثدي والجلد والفتق.</p>
      <p>يتميز قسم الجراحة العامة في مستشفانا باعتماد تقنيات الجراحة بالمنظار التي تسرع وتيرة الشفاء، وتقلل من الآلام والمضاعفات ومدة الإقامة بالمستشفى مقارنة بالجراحات التقليدية المفتوحة.</p>
      <div class="feat-list">
        <div class="feat-item"><span class="feat-icon">🔪</span><div class="feat-text"><strong>الجراحة بالمنظار</strong><span>تدخلات جراحية دقيقة بأقل شقوق جراحية ممكنة</span></div></div>
        <div class="feat-item"><span class="feat-icon">🏥</span><div class="feat-text"><strong>غرف عمليات متطورة</strong><span>بيئة معقمة ومجهزة بأحدث التكنولوجيا الطبية</span></div></div>
        <div class="feat-item"><span class="feat-icon">🧑‍⚕️</span><div class="feat-text"><strong>طاقم وتخدير آمن</strong><span>عناية فائقة قبل وخلال وبعد التدخل الجراحي</span></div></div>
      </div>
    </div>
    <div class="reveal-l">
      <div class="about-visual">
        <div class="av-badge">⭐ دقة واعتمادية</div>
        <div class="av-icon">🔪</div>
        <h4>قسم الجراحة العامة</h4>
        <p>نعمل بأمانة واحترافية كبرى لضمان سلامتك ونجاح كل تداخل جراحي مهما بلغ تعقيده.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="ops-sec">
  <div style="max-width:1200px;margin:auto">
    ...
    <div class="ops-grid">
      <div class="op-card reveal"><div class="op-icon">🫃</div><div class="op-title">جراحات الجهاز الهضمي</div><p class="op-desc">الاستئصال والعلاج لمشاكل المعدة والأمعاء والقولون باستخدام المناظير.</p><span class="op-tag">🔹 جراحة جهاز هضمي</span></div>
      <div class="op-card reveal"><div class="op-icon">🔥</div><div class="op-title">استئصال المرارة والزائدة</div><p class="op-desc">جراحات آمنة وسريعة لاستئصال التهابات الزائدة الدودية وحصى المرارة بالمنظار.</p><span class="op-tag">🔹 جراحة شائعة</span></div>
      <div class="op-card reveal"><div class="op-icon">🎗️</div><div class="op-title">جراحات الفتق</div><p class="op-desc">التصليح الجراحي المفتوح وبالمنظار لأنواع الفتوق البسيطة والمعقدة مع وضع شبكة.</p><span class="op-tag">🔹 جراحة دقيقة</span></div>
      <div class="op-card reveal"><div class="op-icon">🦋</div><div class="op-title">جراحات الغدد</div><p class="op-desc">استئصال الأورام والالتهابات في الغدة الدرقية والكظرية وغيرها.</p><span class="op-tag">🔹 جراحات متخصصة</span></div>
      <div class="op-card reveal"><div class="op-icon">🩹</div><div class="op-title">إصابات وأورام الجلد</div><p class="op-desc">الاستئصال الجراحي التجميلي والعلاجي لأورام الجلد السطحية والتكيسات.</p><span class="op-tag">🔹 تدخل صغرى</span></div>
      <div class="op-card reveal"><div class="op-icon">🚨</div><div class="op-title">الجراحات الطارئة</div><p class="op-desc">التدخل السريع لإنقاذ حياة المرضى في حالات الحوادث، النزيف الدخلي، والتهاب البطن الحاد.</p><span class="op-tag">🔹 طوارئ منقذة</span></div>
    </div>
  </div>
</section>
...
<section class="visit-sec">
  <div style="max-width:1200px;margin:auto">
    <div class="sec-header reveal">
      ...
      <h2 class="sec-title">متى تحتاج استشارة جراحيّة؟</h2>
      <div class="sec-line"></div>
    </div>
    <div class="visit-grid">
      <div class="visit-card reveal"><div class="visit-icon">😧</div><h4>ألم حاد في البطن</h4><p>الألم الشديد المستمر في منطقة البطن قد يشير إلى التهاب الزائدة أو المرارة.</p></div>
      <div class="visit-card reveal"><div class="visit-icon">🤰</div><h4>بروز كتل وتورم</h4><p>ظهور كتل جديدة تحت الجلد أو بروز فتق أثناء السعال والجهد العضلي.</p></div>
      <div class="visit-card reveal"><div class="visit-icon">⚠️</div><h4>إصابات أو نزيف</h4><p>الإصابات العنيفة والرضوض البليغة تتطلب تقييماً فورياً لاستبعاد النزيف الداخلي.</p></div>
      <div class="visit-card reveal"><div class="visit-icon">🩺</div><h4>تغيرات مزمنة</h4><p>توجيه من طبيب العائلة لإجراء استئصال أو تدخل جراحي لوجود أمراض مستعصية تتطلب ذلك.</p></div>
    </div>
  </div>
</section>
...
<section class="appt-sec" id="appointment">
  <div style="max-width:1200px;margin:auto">
    <div class="sec-header reveal">
      ...
      <h2 class="sec-title">احجز موعدك في قسم الجراحة</h2>
      <div class="sec-line"></div>
    </div>
      ...
      <div class="appt-body">
        ...
        <div class="fg">
          ...
          <select id="ftype">
            ...
            <option>استشارة جيرحية عامة</option>
            <option>فحص ما بعد تحويل أو فحص سريري</option>
            <option>مشاكل مرارة وزائدة</option>
...
<footer>
  <div class="footer-inner">
    ...
    <div class="footer-col">
      ...
      <ul class="footer-links">
        <li><a href="{{ route('general.surgery') }}">الجراحة العامة</a></li>
        <li><a href="{{ route('surgery.women') }}">جراحة النساء</a></li>
        <li><a href="{{ route('orthopedics') }}">جراحة العظام</a></li>
        <li><a href="{{ route('urology') }}">جراحة المسالك البولية</a></li>
      </ul>
    </div>
    <div class="footer-col">
...
function handleBooking() {
  ...
  if (valid) {
    alert('✅ تم استلام طلب الحجز بنجاح!\nسيتصل بك فريق الجراحة العامة قريباً لتأكيد الموعد.');
